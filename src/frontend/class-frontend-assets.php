...
namespace BrianHenryIE\WP_KBS_OmniForm\Frontend;

use BrianHenryIE\WP_KBS_OmniForm\Settings;
...
class Frontend_Assets {
	...
	public function enqueue_styles(): void {
		...
		wp_enqueue_style( 'bh-wp-kbs-omniform', $plugin_url . 'assets/bh-wp-kbs-omniform-frontend.css', array(), $version, 'all' );
	...
	public function enqueue_scripts(): void {
		...
		wp_enqueue_script( 'bh-wp-kbs-omniform', $plugin_url . 'assets/bh-wp-kbs-omniform-frontend.js', array( 'jquery' ), $version, false );
